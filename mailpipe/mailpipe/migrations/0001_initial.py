...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mailpipe_emailaccount', (
        ...
        db.send_create_signal(u'mailpipe', ['EmailAccount'])

        # Adding model 'Email'
        db.create_table(u'mailpipe_email', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(related_name='emails', to=orm['mailpipe.EmailAccount'])),
            ('message', self.gf('django.db.models.fields.TextField')()),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'mailpipe', ['Email'])


    def backwards(self, orm):
        # Deleting model 'EmailAccount'
        db.delete_table(u'mailpipe_emailaccount')

        # Deleting model 'Email'
        db.delete_table(u'mailpipe_email')
    ...
    models = {
        ...
        u'mailpipe.email': {
            ...
            'account': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'emails'", 'to': u"orm['mailpipe.EmailAccount']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.TextField', [], {})
        },
        u'mailpipe.emailaccount': {
